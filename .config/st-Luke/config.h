...
static Shortcut shortcuts[] = {
	...
	// P: ctrl -- my own definitions. But it conflicts with vim's original, so ctrl+d, ctrl+u doesn't work. 
	//{ ctrl,               	XK_k,           kscrollup,      {.i =  1} },
	//{ ctrl,               XK_j,           kscrolldown,    {.i =  1} },
	//{ ctrl,               XK_u,           kscrollup,      {.i = -1} },
	//{ ctrl,               XK_d,           kscrolldown,    {.i = -1} },
